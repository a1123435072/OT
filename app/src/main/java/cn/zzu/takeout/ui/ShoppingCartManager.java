...
public class ShoppingCartManager {
    ...
    public CopyOnWriteArrayList<Eat> goodsInfos = new CopyOnWriteArrayList<>();
    public long sellerId;
    public String name;
    public String url;
    public int sendPrice;

    private Integer totalNum = 0; //保存 购物车中的数量
     ...
     * @param info
     */
    public Integer addGoods(Eat info) {
        int num = 0;
        // 判断容器中是否含有该商品
        // 如果有做++
        // 如果没有，添加一条记录
     ...
     * @param info
     */
    public Integer minusGoods(Eat info) {
        Integer num = 0;
        // 做- -
        // 判断：减少后数量是为0
        // 为0 做删除商品处理

...
public class orderFragmentPresenter extends BasePresenter {
    ...
    public orderFragmentPresenter(rvOrderAdapter adapter) {
     ...
     * 获取服务器短首页数据
     */
    public void getOderData(String id) {

        Call<ResponseInfo> call = responseInfoAPI.order( id);
    ...
    private void parserData(String data) {
        ...
        ArrayList<Order> orderBean = gson.fromJson(data,typeToken.getType());

        // HomeBean.Seller.
        //fragment.success();
        fragment.getAdapter().setDate(orderBean);
